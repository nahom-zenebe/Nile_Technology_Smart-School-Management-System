    ...
    <div>
      ...
      <div className="flex flex-col min-h-screen">
        <div className="flex-grow max-w-7xl mx-auto py-8">
          {/* Hero Section */}
          <motion.section
            className="w-full h-screen bg-gradient-to-r flex flex-col-reverse md:flex-row items-center py-16 mt-12"
            ...
            <div className="w-full md:w-1/2 px-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <button
                  ...
                  className="bg-green-500 w-40 hover:bg-green-700 ml-0 sm:ml-10 text-white font-bold py-3 px-6 rounded-lg"
                >
                  Login
                </button>
              </div>
          ...
          <motion.section
            className="py-16 bg-green-300 rounded-xl mt-10"
